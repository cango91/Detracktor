...
/**
 * Integration tests for the ShareUntracked app
...
class IntegrationTest {
    ...
    fun useAppContext() {
        ...
        assertEquals("com.example.shareuntracked", appContext.packageName)
    }
    ...
    fun testConfigManagerIntegration() {
        ...
        // Test that we can get default rules
    ...
    fun testConfigManagerFileOperations() {
        ...
        // Test that default rules are available
        val defaultRules = configManager.getDefaultRules()
        assertNotNull("Default rules should be available", defaultRules)
    }
